...
function M.show_nui_config_form(config, project_path)
	...
	-- Handle selection
	popup:map("n", "1", function()
		popup:unmount()
		M.set_build_system(config, project_path)
	end)
	popup:map("n", "2", function()
		popup:unmount()
		M.set_run_command(config, project_path)
	end)
	popup:map("n", "3", function()
		popup:unmount()
		M.set_test_command(config, project_path)
	end)
	popup:map("n", "4", function()
		popup:unmount()
		M.set_debug_program(config, project_path)
	end)
	popup:map("n", "5", function()
		popup:unmount()
		M.set_debug_adapter(config, project_path)
	end)
	popup:map("n", "6", function()
		popup:unmount()
		M.set_compiler_flags(config, project_path)
	end)
